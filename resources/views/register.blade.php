                                    ...
                                    <div class="card-body">
										...
										{{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="custom-control-input" id="is_super_admin" type="checkbox" name="is_super_admin" />
                                                <label class="custom-control-label" for="is_super_admin"> Is Super Admin</label>
                                                @if ($errors->has('is_super_admin'))
												  <span class="error">{{ $errors->first('is_super_admin') }}</span>
												@endif
                                                </div>
											</div>
